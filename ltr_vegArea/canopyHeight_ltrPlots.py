...
lidarLibDir = r'D:\Gold_Pipeline\ProcessingPipelines\Lidar\lib\Python'

if lidarLibDir not in sys.path:
    sys.path.insert(0, lidarLibDir)

from aop_utils import *
...
if __name__ == '__main__':
    ...
    #YearSiteVisitNameList = ['2021_DSNY_6', '2020_UKFS_5', '2021_MLBS_4', '2021_SOAP_5', '2021_WREF_4', '2020_YELL_3', '2021_DEJU_4']
    ...
    for i in range(len(YearSiteVisitNameList)):
        ...
        try:
            ...
            print("--- %s seconds ---" % (time.time() - start_time))
    DFcalcCHM.to_csv("C:/Users/kmurphy/Documents/Git/neon-plant-sampling/ltr_vegArea/allLitterPlots_CalculatedCHMpct_v2.csv")
