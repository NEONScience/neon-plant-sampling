...
equations <- read.csv(paste(wdir, 'vst_allometries/SourceData/allometries/chojnacky_assignment.csv', sep='/'),
                      stringsAsFactors = F)

parameters <- read.csv(paste(wdir, 'vst_allometries/SourceData/allometries/chojnacky_parameters.csv', sep='/'),
                       stringsAsFactors = F)
