...
lidsDF$siteID <- stringr::str_sub(string = lidsDF$plotID, 1, 4)
lidsDF$lidsConcat <- paste0(lidsDF$lidsAngle1,"|",lidsDF$lidsAngle2,"|", lidsDF$lidsAngle3)
#lidsDF$plotType <- NULL
