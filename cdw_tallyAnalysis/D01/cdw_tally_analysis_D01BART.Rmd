---
title: "CDW Tally Analysis: D01 BART"
...
if(file.exists("~/Documents/workDocuments")){
  inpath <- "~/Documents/workDocuments/gitRepositories/neonPlantSampling/cdw_tally_analysis/fulcrumData_20170217/"
  domain <- "D01"
  site <- "BART"
...
if(file.exists("~/Documents/neonScienceDocs")){
  inpath <- "~/Documents/neonScienceDocs/gitRepositories/neonPlantSampling/cdw_tally_analysis/fulcrumData_20170217/"
  domain <- "D01"
  site <- "BART"
...
cdw <- dplyr::filter(cdw, domainid==domain, siteid==site)
