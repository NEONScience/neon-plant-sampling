...
- Re-ran tally rank abundance analysis following corrections to determine whether CDW DST list is affected.
...
## Write data file
write.csv(cdw, file = paste(outpath, paste(domain, site, "merged","cdw_rawdata_20220818.csv", sep="_"), sep = "/"))
...
write.csv(t1, file = paste(outpath, paste(domain, site, "tally_abundance_20220818.csv", sep = "_"), sep = "/"), row.names = F)
```
