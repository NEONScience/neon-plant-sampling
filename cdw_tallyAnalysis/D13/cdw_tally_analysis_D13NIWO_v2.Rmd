---
title: "CDW Tally Analysis: D13 NIWO"
...
##  Filter to analyze only data from 2019 eventID due to increased taxonomic data quality in 2019
cdw %>% filter(eventid == "CDW.2019.NIWO") -> cdw

#   Write filtered data to input file for log of which data used for analysis
write.csv(cdw, file=paste(outpath, "NIWO_inputData_20191014.csv", sep = "/"), row.names = FALSE)
